...
📊 Funcionalidades
- Cadastro automatizado de caixas de arquivo.
- Registro de data de entrada automático.
- Exportação de inventário para auditoria e controle administrativo.

---
*Projeto parte do meu aprendizado em Análise e Desenvolvimento de Sistemas (Unicesumar).*
